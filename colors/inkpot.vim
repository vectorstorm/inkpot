...
if has("gui_running")
    ...
    exec "hi QuickFixLine   cterm=NONE   ctermfg=" . <SID>X(80) . " ctermbg=" . <SID>X(52)
    ...
    exec "hi StatusLine     cterm=BOLD   ctermfg=" . <SID>X(86) . " ctermbg=" . <SID>X(82)
    exec "hi User1          cterm=BOLD   ctermfg=" . <SID>X(28) . " ctermbg=" . <SID>X(81)
    exec "hi User2          cterm=BOLD   ctermfg=" . <SID>X(39) . " ctermbg=" . <SID>X(81)
    exec "hi StatusLineNC   cterm=NONE   ctermfg=" . <SID>X(83) . " ctermbg=" . <SID>X(81)
